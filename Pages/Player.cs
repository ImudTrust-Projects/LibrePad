...
{GetCreationDate(targetRig.OwningNetPlayer.UserId, (str) => updateTime = 0f)}");
                ...
                if (cosmeticSet.items.Any(cosmetic => !cosmetic.isNullItem && !string.Concat(targetRig._playerOwnedCosmetics).ToLower().Contains(cosmetic.itemName.ToLower())))
    ...
    {
        string concatStringOfCosmeticsAllowed = string.Concat(rig._playerOwnedCosmetics).ToLower();
...
{ "ObsidianMC", new ModInfo { name = "Obsidian", legal = false } },
{ "Hidden Menu", new ModInfo { name = "Hidden", legal = false } },
{ "ElixirMenu", new ModInfo { name = "Elixir", legal = false } },
{ "Elixir", new ModInfo { name = "Elixir", legal = false } },
{ "MistUser", new ModInfo { name = "Mist", legal = false } },
{ "Untitled", new ModInfo { name = "Untitled", legal = false } },
{ "Euphoric", new ModInfo { name = "Euphoria", legal = false } },
{ "CurrentEmote", new ModInfo { name = "Vortex Emotes", legal = false } },
{ "Explicit", new ModInfo { name = "Explicit Menu", legal = false } },
{ "envision build transform flourish", new ModInfo { name = "Envision", legal = false } },
{ "https://chqser.lol/", new ModInfo { name = "Chqser", legal = false } },
{ "y u lookin in here wei", new ModInfo { name = "Malachi", legal = false } },
{ "explicit", new ModInfo { name = "Explicit", legal = false } },
{ "Track Track Track Sahur", new ModInfo { name = "Track Track Track Sahur Tracker", legal = false } },
{ "R3_MENU", new ModInfo { name = "R3 Menu", legal = false } },
{ "ZlothYDances", new ModInfo { name = "ZlothY Dances", legal = false } },
{ "1y u lookin in here weirdo", new ModInfo { name = "Malachi Menu", legal = false } },
{ "UsingGalacticMenu", new ModInfo { name = "Galactic Menu", legal = false } },
{ "AtlasNetworkedConsent", new ModInfo { name = "Atlas", legal = false } },
{ "ShizukuModMenu", new ModInfo { name = "Shizuku Menu", legal = false } },
{ "GPronouns", new ModInfo { name = "GPronouns", legal = true } },
{ "GorillaShirts", new ModInfo { name = "GShirts", legal = true } },
{ "GorillaShirtsFeb26", new ModInfo { name = "GorillaShirts26", legal = true } },
{ "GorillaTrackPacked", new ModInfo { name = "Gorilla Track", legal = true } },
{ "Gorilla Track 2.3.0", new ModInfo { name = "GTrack", legal = true } },
{ "GorillaTorsoEstimator", new ModInfo { name = "Torso Estimation", legal = true } },
{ "GorillaNametags", new ModInfo { name = "GNametags", legal = true } },
{ "DeeTags", new ModInfo { name = "Dee Tags", legal = true } },
{ "Boy Do I Love Information", new ModInfo { name = "BDILI", legal = true } },
{ "NametagsPlusPlus", new ModInfo { name = "Nametags++", legal = true } },
{ "WalkSimulator", new ModInfo { name = "WalkSim ZlothY Fix", legal = true } },
{ "Dingus", new ModInfo { name = "dingus", legal = true } },
{ "Graze Heath System", new ModInfo { name = "Health System", legal = true } },
{ "Gorilla Track Packed", new ModInfo { name = "Gorilla Track", legal = true } },
{ "drowsiiiGorillaInfoBoard", new ModInfo { name = "GInfo Board", legal = true } },
{ "MonkeCosmetics::Material", new ModInfo { name = "Monke Cosmetics", legal = true } },
{ "github.com/arielthemonke/GorillaCraftAutoBuilder", new ModInfo { name = "GCraft Auto Builder", legal = true } },
{ "usinggphys", new ModInfo { name = "GPhys", legal = true } },
{ "GorillaChatBox", new ModInfo { name = "Gorilla Chat Box", legal = true } },
{ "fallmonke_prop", new ModInfo { name = "Fall Monke", legal = true } },
